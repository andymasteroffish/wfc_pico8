...
state = "playing"	--playing, game_over, level_complete
cur_floor = 1
...
function _draw()
	...
	if (state == "playing") then
		...
		rect(0,1, 34,9, 2)
		spr(5, 3, 2)
		print("X"..tostr(keys).."/"..tostr(keys_needed[cur_floor]), 13, 3, 7)
...
function draw_level_complete()
	...
	local y_pos = 5
	cprint("floor.."..tostr(cur_floor).." complete", box_w/2, y_pos, t_col)
...
function do_first_move()
	...
	cur_move = make_check_point(cur_move)
	cur_move.move(start_x, start_y+2, 4)
	update_board_from_move(cur_move, true, false)
end
...
00000000000000000000000000000000000000000000000000444000000000000000000000000000099099900000000000000000000000000000000000000000
...
000000000000000000000000000000000000000077ffff0f9655559000f440001111111100000000a88888880000000000000000000000000000000000000000
...
00000000000000000000000000000000000000000f000f7446555540009940001111111c00000000888888880000000000000000000000000000000000000000
...
00000000000000000000000000000000000000000000000046500040000000001111111100000000899888880000000000000000000000000000000000000000
...

...

...

